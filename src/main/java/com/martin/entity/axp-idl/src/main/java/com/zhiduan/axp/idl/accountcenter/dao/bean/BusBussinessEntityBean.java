package com.ly.bs.modules.accountcenter.bean;

import java.io.Serializable;
import java.util.Date;

/**
* @ClassName: BusBussinessEntityBean
* @Description: 系统用户日志
* @author wangyu
* @date 2017-06-12 13:59:37
*/
public class BusBussinessEntityBean implements Serializable {
    ...
    **/
    ...
    public BusBussinessEntityBean() {
        super();
    }

    public BusBussinessEntityBean(Long bussinessid, String bizname, Integer bizflag, Integer bizamount, Long biztype, Long bizchargingrules) {
